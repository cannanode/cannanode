Contributing to CNODE Core
==================================

The CNODE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CNODE Core project, and is not to be
confused with overall CNODE Network Protocol consensus changes.

Whether a pull request is merged into CNODE Core rests with the project merge
...
Patches that change CNODE consensus rules are considerably more involved than
...
Where a patch set proposes to change the CNODE consensus, it must have been
...
The project leader is the release manager for each CNODE Core release.
