...
RESOURCES += src/qt/CNODE.qrc src/qt/CNODE_locale.qrc

TRANSLATIONS += src/qt/locale/CNODE_bg.ts \
                src/qt/locale/CNODE_de.ts \
                src/qt/locale/CNODE_en.ts \
                src/qt/locale/CNODE_es.ts \
                src/qt/locale/CNODE_fi.ts \
                src/qt/locale/CNODE_fr.ts \
                src/qt/locale/CNODE_it.ts \
                src/qt/locale/CNODE_ja.ts \
                src/qt/locale/CNODE_pl.ts \
                src/qt/locale/CNODE_pt.ts \
                src/qt/locale/CNODE_ru.ts \
                src/qt/locale/CNODE_sk.ts \
                src/qt/locale/CNODE_sv.ts \
                src/qt/locale/CNODE_vi.ts \
                src/qt/locale/CNODE_zh_CN.ts \
                src/qt/locale/CNODE_zh_TW.ts
