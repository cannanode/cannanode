...
Intro
-----
CNODE (CNODE) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CNODE utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run CNODE-qt.exe.

CNODE Core is the original CNODE client and it builds the backbone of the network.
However, it downloads and stores the entire history of CNODE transactions;
