...
In order to support loading of multiple wallets in CNODE-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CNODE.cpp.
...
Changes to CNODE.cpp
----------------------
CNODE.cpp is the entry point into CNODE-qt, and as such, will require some minor modifications to provide hooks for
