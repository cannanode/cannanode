...
This mechanism has been integrated into Bitcore-Node-CNODE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cannanode/insight-api-CNODE#web-socket-api](https://github.com/cannanode/insight-api-CNODE#web-socket-api)
* API: [https://github.com/cannanode/insight-api-CNODE#swifttx-transactions](https://github.com/cannanode/insight-api-CNODE#swifttx-transactions)
...
By default, the CNODE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CNODE Core daemon:
