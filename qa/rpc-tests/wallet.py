...
#   c) node1 mines 32 blocks, so now node 0 has 500000CNODE, node 1 has 4250CNODE, node2 has none.
#   d) node0 sends 601 CNODE to node2, in two transactions (301 CNODE, then 300 CNODE).
