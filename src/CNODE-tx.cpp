...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CNODE Core CNODE-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CNODE-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CNODE transaction") + "\n" +
                               "  CNODE-tx [options] -create [commands]   " + _("Create hex-encoded CNODE transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CNODE transaction
