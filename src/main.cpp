...
#if defined(NDEBUG)
#error "CNODE cannot be compiled without assertions."
#endif
...
int64_t nReserveBalance = 1;

/** Fees smaller than this (in uCNODE) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // CNODE: We use certain sporks during IBD, so check to see if they are
