                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CNODE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CNODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CNODE: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CNODE Core"), this);
    aboutAction->setStatusTip(tr("Show information about CNODE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CNODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CNODE addresses"));
    ...
    openAction->setStatusTip(tr("Open a CNODE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CNODE Core help message to get a list with possible CNODE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CNODE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CNODE network", "", count));
}
...
{
    QString strTitle = tr("CNODE Core"); // default title
