...
/** Utility functions used by the CNODE Qt UI.
 */
namespace GUIUtil
{
...
// Render CNODE addresses in monospace font
...
// Parse "CNODE:" URI into recipient object, return true on successful parsing
