...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CNODE features */
        {"CNODE", "masternode", &masternode, true, true, false},
        {"CNODE", "listmasternodes", &listmasternodes, true, true, false},
        {"CNODE", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CNODE", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CNODE", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CNODE", "masternodedebug", &masternodedebug, true, true, false},
        {"CNODE", "startmasternode", &startmasternode, true, true, false},
        {"CNODE", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CNODE", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CNODE", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CNODE", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CNODE", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CNODE", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CNODE", "mnbudget", &mnbudget, true, true, false},
        {"CNODE", "preparebudget", &preparebudget, true, true, false},
        {"CNODE", "submitbudget", &submitbudget, true, true, false},
        {"CNODE", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CNODE", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CNODE", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CNODE", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CNODE", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CNODE", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CNODE", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CNODE", "checkbudgets", &checkbudgets, true, true, false},
        {"CNODE", "mnsync", &mnsync, true, true, false},
        {"CNODE", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> CNODE-cli " + methodname + " " + args + "\n";
}
